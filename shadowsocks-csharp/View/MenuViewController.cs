...
namespace Shadowsocks.View
{
    public class MenuViewController
    {
        ...
        {
            Process.Start("https://www.v2dn.net/node/1");
        }

        private void AboutItem_Click(object sender, EventArgs e)
        {
            Process.Start("https://github.com/popkings/ShadowsocksV-About/wiki");
        }
        ...
        {
            controller.UpdatePACFromOnlinePac("https://raw.githubusercontent.com/popkings/gfw_whitelist/master/ssv/ss_lanip.pac");
        }

        private void UpdatePACFromCNWhiteListItem_Click(object sender, EventArgs e)
        {
            controller.UpdatePACFromOnlinePac("https://raw.githubusercontent.com/popkings/gfw_whitelist/master/ssv/ss_white.pac");
        }

        private void UpdatePACFromCNOnlyListItem_Click(object sender, EventArgs e)
        {
            controller.UpdatePACFromOnlinePac("https://raw.githubusercontent.com/popkings/gfw_whitelist/master/ssv/ss_v_white.pac");
        }

        private void UpdatePACFromCNIPListItem_Click(object sender, EventArgs e)
        {
            controller.UpdatePACFromOnlinePac("https://raw.githubusercontent.com/popkings/gfw_whitelist/master/ssv/ss_cnip.pac");
        }
